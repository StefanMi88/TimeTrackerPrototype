	...
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
					<%	//if a projectId exists as URL param, go to edit view
						if (request.getParameter("projectId") != null) {
							...
							try {
								...
								<!-- List existing Tasks in project -->
								<div class="col-md-12">
									<div class="card">
										<div class="header">
						...
						//default: show existing projects and new project form		
						} else {
						%>
								...
								<div class="content table-responsive table-full-width">
									<table class="table table-hover table-striped">
										...
										<tbody>
											<%
												try {
														// Display already existing Projects
														db.getEntityManager().getTransaction().begin();
