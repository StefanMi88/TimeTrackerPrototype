        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Edit Project</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Enter task and click create button</p>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Click the add icon on the right to add Users to the task</p>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                        	<td>1</td>
                                        	<td>Sample Task F</td>
                                        	<td>Do Something important</td>
                                            <td><a href="add_user_task.html" title="Add"><span class="pe-7s-edit"></span></a></td>
                                        </tr>
                                        <tr>
                                        	<td>2</td>
                                        	<td>Sample Task F</td>
                                        	<td>Do some Documentation</td>
                                            <td><a href="add_user_task.html" title="Add"><span class="pe-7s-edit"></span></a></td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>Sample Task G</td>
                                            <td>Do some Implementing</td>
                                            <td><a href="add_user_task.html" title="Add"><span class="pe-7s-edit"></span></a></td>
                                        </tr>
                                    </tbody>
                                </table>
